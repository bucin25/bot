...
class App extends CI_Controller {
  ...
  */
  ...
  public function menu()
  {
    ...
    $this->climate->out(" {$this->cyan}  [¤ {$this->reset}AT{$this->cyan} ¤] {$this->blue}    ABOUT THIS TOOLS      {$this->cyan}[¤ {$this->reset}RC{$this->cyan} ¤]");
    $this->climate->out(" {$this->cyan}  [¤ {$this->reset}EX{$this->cyan} ¤] {$this->violet}          EXIT            {$this->cyan}[¤ {$this->reset}RC{$this->cyan} ¤]");
    $this->climate->out(" {$this->cyan}¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤");
    $this->climate->out(" {$this->cyan}¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤");
