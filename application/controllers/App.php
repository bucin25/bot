...
class App extends CI_Controller {
  ...
  */
  ...
  public function menu()
  {
    ...
    $this->climate->out(" {$this->cyan} [¤ {$this->reset}RC{$this->cyan} ¤] {$this->reset}REMOVE COOKIE        [¤ {$this->reset}RC{$this->cyan} ¤]");
    $this->climate->out(" {$this->cyan} [¤ {$this->reset}RB{$this->cyan} ¤] {$this->reset}REPORT BUG")         [¤ {$this->reset}RC{$this->cyan} ¤];
    $this->climate->out(" {$this->cyan} [¤ {$this->reset}UT{$this->cyan} ¤] {$this->reset}UPDATE TOOLS")       [¤ {$this->reset}RC{$this->cyan} ¤];
    $this->climate->out(" {$this->cyan} [¤ {$this->reset}SC{$this->cyan} ¤] {$this->reset}SEE YOUR FACEBOOK COOKIES") [¤ {$this->reset}RC{$this->cyan} ¤];
    $this->climate->out(" {$this->cyan} [¤ {$this->reset}AT{$this->cyan} ¤] {$this->reset}ABOUT THIS TOOLS")    [¤ {$this->reset}RC{$this->cyan} ¤];
    $this->climate->out(" {$this->cyan} [¤ {$this->reset}EX{$this->cyan} ¤] {$this->reset}EXIT")        [¤ {$this->reset}RC{$this->cyan} ¤];
    $this->climate->out(" {$this->cyan}¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤");
    $this->climate->out("");
    $this->climate->out("");
